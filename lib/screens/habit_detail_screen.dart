  ...
  void _showArchiveConfirmation(BuildContext context, Habit currentHabit) {
    ...
    Get.dialog(
      AlertDialog(
        ...
        content: Text(
          isArchived
              ? 'Habit "${widget.habit.title}" akan dikembalikan ke daftar habit aktif.'
              : 'Habit "${widget.habit.title}" akan dipindahkan ke arsip. Habit tidak akan muncul di halaman utama, tapi data progress tetap aman.',
          style: const TextStyle(
            fontFamily: 'Plus Jakarta Sans',
            color: Colors.white70,
          ),
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              final habitController = Get.find<HabitController>();
              if (isArchived) {
                habitController.unarchiveHabit(widget.habit.id!);
              } else {
                habitController.archiveHabit(widget.habit.id!);
              }
            },
            child: Text(
              ...
              style: TextStyle(
                fontFamily: 'Plus Jakarta Sans',
                color: isArchived ? AppTheme.primary : const Color(0xFFF59E0B),
                fontWeight: FontWeight.bold,
              ),
            ),
          ),
